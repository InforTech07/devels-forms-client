    ...
    template: `
        <div class="w-56 h-64 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col items-center justify-center">
                ...
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    <button (click)="showPreview(survey.id)" type="button" class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-s-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                    ...
                    <button type="button" (click)="navigateToSurveyResponse(survey.id)" class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-e-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
...
export class CardComponent{
    ...
    @Output() showPreviewSurvey = new EventEmitter<number>();
    ...
    showPreview(id: number) {
        this.showPreviewSurvey.emit(id);
    }
     navigateToSurveyResponse(id: number) {
        this.router.navigate([`app/survey/${id}/responses`]);
     }
}
